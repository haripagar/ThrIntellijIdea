...
def test_OrderPass():
    ...
    time.sleep(1)
    IncludesEggToggleBtn.click()
    SearchItm = HP.find_element(By.XPATH, "//header/div[1]/div[5]/div[1]/input[1]")
    ...
    AddItem1.click()
    time.sleep(2)
    ViewCart = HP.find_element(By.XPATH, "//body/app-root[1]/div[1]/app-browse-menu[1]/div[3]/div[2]/div[1]/div[1]/div[2]")
    ViewCart.click()
    time.sleep(2)
...
# time.sleep(2)
    ...
    SelHDFC = HP.find_element(By.XPATH,
                          "//body/app-root[1]/div[1]/app-your-order[1]/app-payments[1]/div[1]/app-payments-netbanking[1]/div[1]/div[1]/div[1]/div[1]/div[1]")
    SelHDFC.click()
    time.sleep(2)
